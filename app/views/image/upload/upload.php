...
<div class="container">
    ...
    <form id="fileupload" data-url="<?=Url::toRoute('image/upload/handle')?>" action="<?=Url::toRoute('image/upload/handle')?>" method="POST" enctype="multipart/form-data">
         ...
         {% if (!file.error) { %}
           <td>
            <p class="name">
                ...
                <a href="/image/contrast/index?filename={%=file.name%}" target="blank">查看对照</a>
            </p>
        </td>
